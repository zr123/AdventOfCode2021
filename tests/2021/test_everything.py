...
#    ("12", 2, "inputs/input12_test1.txt",   36), # bugged
    ...
    ("16", 2, "inputs/input16.txt",         10185143721112),
    ("17", 1, "inputs/input17_test.txt",    45),
    ("17", 1, "inputs/input17.txt",         15931),
    ("17", 2, "inputs/input17_test.txt",    112),
    ("17", 2, "inputs/input17.txt",         2555),
